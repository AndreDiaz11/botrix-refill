...
## Estado
Funcional: sí | Beta: no (`v1.5.2`) | Última revisión (15/09/2026): el fix de espaciado de v1.5.1 solo movió el hueco vacío del medio de la fila al final de la tabla — corregido de raíz achicando el ancho máximo del cuerpo del Shop para que calce con el contenido real, sin columna espaciadora. También rehechos los íconos de campana (Notificaciones) y de refrescar puntos, esta vez con formas simples separadas (polígono/círculo/arco+triángulo) en vez de un solo trazo compuesto. **Pendiente de confirmación visual del usuario**.
