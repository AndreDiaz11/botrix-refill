...
1. **Setup** (al abrir si no hay streamer/Session-kid guardado): tarjeta con 3 secciones tipo acordeón — **Streamer** (abierta por defecto), **Session-kid** y **Telegram** (colapsadas). Telegram vive únicamente aquí — toggle + Bot Token + Chat ID + botón "Probar conexión". Botón "▶ Iniciar monitoreo".
